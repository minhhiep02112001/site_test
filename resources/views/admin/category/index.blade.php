                    ...
                    $.ajax({
                        ...
                        success: function(response) {
                            ...
                            if (response.data_info.thumbnail) {
                                ...
                                parent_thumb.find('img').addClass('show').attr('src', FUNC.getImageThumb(response.data_info.thumbnail));
                                parent_thumb.append(
                                    `<input type="hidden" name="thumbnail" value="${response.data_info.thumbnail}">`
                                );
                            }  
                            if (response.data_info.icon) {
                                let parent_thumb = modal_form.find(
                                    'div[data-field-name="icon"] .upload-box');
                                parent_thumb.find('img').addClass('show').attr('src', FUNC.getImageThumb(response.data_info.icon));
                                parent_thumb.append(
                                    `<input type="hidden" name="icon" value="${response.data_info.icon}">`
                                );
                            }   
