                        ...
                        <form action="" id="form-filter-data" class="p-1 border rounded bg-light">
                            <fieldset>
                                ...
                                <div class="form-row">
                                    ...
                                    <!-- Title Input -->
                                    <div class="form-group col-md-4">
                                        <label for="data_id">Id liên quan:</label>
                                        <input type="text" name="params[data_id]" class="form-control" id="data_id"
                                            placeholder="Nhập id...">
                                    </div>
                                    <!-- Email Input -->
                                    <div class="form-group col-md-4">
...
@push('scripts')
    ...
    <script>
        //setting url
        var url_ajax_list = window.APP_URL + "/admin/ajax/comment";
        var url_ajax_edit = window.APP_URL + "/admin/comment";
        // Dom Ready
