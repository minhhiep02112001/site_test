...
<body>
  <nav class="navbar sticky-top navbar-expand-lg navbar-dark" id="nav">
    ...
    <div class="collapse navbar-collapse flex-grow-0" id="nav-buttons">
      <ul class="navbar-nav">
            <li class="nav-item">
                <a class="nav-link" data-toggle="collapse" href="#form-search" role="button"
                   aria-expanded="false" aria-controls="form-search">
  ...
  <div class="d-flex flex-row">
    ...
    <div id="main">
      ...
      <nav aria-label="breadcrumb" class="d-none d-lg-block" id="breadcrumbs">
        ...
        <div class="collapse multi-collapse mb-2" id="form-search">
            <div class="form-group-feedback form-group-feedback-left flex-grow-1 mb-1">
                <input type="text" id="search_file_manager" name="search_file_manager" class="form-control" placeholder="Search">
