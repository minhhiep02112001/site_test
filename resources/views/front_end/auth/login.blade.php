...
@section('content')
    ...
    <div class="wrapper">
        <div class=" margin-bottom-20 mt-5  card p-5">
            <div class="wrap_background_aside margin-bottom-40 page_login">
                <div class="heading-bar text-center">
                    ...
                    <p class="mb-0">Bạn chưa có tài khoản ?
                        <a href="/account/register" class="btn-link-style btn-register" style="text-decoration: underline; ">
                            Đăng
                            ký tại đây</a>
                    </p>
                </div>
                    ...
                    <div class="col-12 col-md-6 col-lg-5 offset-md-3 py-3 mx-auto">
                        ...
                        <div class="page-login ">
                                ...
                                <form id="customer_login"  method="post">  
                                    ...
                                    <div class="form-signup clearfix">
                                        ...
                                        <div class="pull-xs-left button_bottom a-center  mb-3">
                                            <button class="btn btn-block btn-style w-100 btn-login" type="submit"
                            ...
                            <div id="recover-password" style="display:none;" class="form-signup page-login text-center">
                                ...
                                <form accept-charset="UTF-8" id="customer_forgot_password"  method="post">
                                    ...
                                    <div class="action_bottom my-3">
                                        <input class="btn btn-style p-2 btn-recover btn-block" type="submit"
                                            value="Lấy lại mật khẩu">
                                        <a href="#" class=" mt-2 link btn-style-active "
                                            onclick="hideRecoverPasswordForm();return false;">Đăng nhập</a>
